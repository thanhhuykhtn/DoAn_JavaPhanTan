								...
								<ul class="nav navbar-nav">
									...
									<li class="dropdown">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="danhsachmonan.html">Danh sách món ăn</a></li>
											<li><a href="danhsachchinhanh.html">Danh sách chi nhánh</a></li>
											<li><a href="giohang.html">Giỏ hàng</a></li>
											<li><a href="lichsudonhang.html">Lịch sử đơn hàng</a></li>
											<li><a href="timkiemmonan.html">Tìm kiếm món ăn</a></li>
										</ul>
									</li>
